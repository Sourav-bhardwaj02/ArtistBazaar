...
export default function ServiceDashboard() {
  ...
  const fetchServiceData = useCallback(async () => {
      try {
        setLoading(true);
        // Fetch service's products
        const productsData = await apiService.getServiceProducts() as any;
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {/* <Button asChild>
            <Link to={`/service/${user?.id}/products/new`}>
  ...
  <Plus /> Add Product
          ...
          <Button variant="outline" asChild>
            <Link to={`/services/${user?.id}/analytics`}>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Button asChild variant="outline" className="flex flex-col items-center p-4 h-auto relative">
              <Link to={`/services/${user?.id}/chats`}>
            ...
            <Button asChild variant="outline" className="flex flex-col items-center p-4 h-auto">
              <Link to={`/services/${user?.id}/settings`}>
